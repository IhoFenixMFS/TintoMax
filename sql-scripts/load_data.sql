...
INSERT INTO `prendas` (`num_prenda`, `nombre`, `limpieza_siva`, `plancha_siva`, ) VALUES(1, 'pantalon', 5, , 4.1, );
INSERT INTO  (`num_prenda`, `nombre`, `limpieza_siva`,, `plancha_siva` ) VALUES(2, 'camisa', 3.02, 2.36);
...
INSERT INTO `ticket` (`num_ticket`, `id_prenda`, `prenda`, `cantidad`, `servicio`, `im_unit_siva`, `total_siva`, `Observaciones`) VALUES(1, 1, 'pantalon', 1, 'Limpieza', 5, 5, 'En proceso', NULL);
INSERT INTO `ticket` (`num_ticket`, `id_prenda`, `prenda`, `cantidad`, `servicio`, `im_unit_siva`, `total_siva`, `Observaciones`) VALUES(1, 2, 'camisa', 2, 'Limpieza', 3.02, 6.04, 'En proceso', NULL);
INSERT INTO `ticket` (`num_ticket`, `id_prenda`, `prenda`, `cantidad`, `servicio`, `im_unit_siva`, `total_siva`, `Observaciones`) VALUES(2, 1, 'pantalon', 5, 'Plancha', 4.1, 20.50, 'Listo', 'Sin ralla.');
...
INSERT INTO `facturas` (`num_factura`, `dni`, `nombre`, `fecha`, `num_ticket`, `importe_siva`) VALUES(1, '00000002A', 'Andrea', '2018-02-25', 2, 20.04);
